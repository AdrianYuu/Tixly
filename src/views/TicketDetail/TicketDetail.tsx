...
import { ConcertTicketType } from '../../declarations/backend_concert_ticket_type/backend_concert_ticket_type.did';
        ...
        >
          ...
          <div className="flex flex-col px-16">
            {activity?.activityType! == ActivityEnum.MOVIE ? (
              <p className="text-white">{activity?.activityType!}</p>
            ) : (
              <p className="text-white">assa</p>
            )}
            <TicketBanner
